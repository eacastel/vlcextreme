...
import { FaMicrochip, FaMemory, FaLayerGroup } from "react-icons/fa"; // Icons for specs
...
const ProductionBuildCard = ({ build }) => {
  ...
  return (
    <div className="relative bg-dark-gray rounded-xl shadow-lg border border-white/5 transition-all hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] hover:border-neon-cyan/50 flex flex-col h-full group overflow-hidden">
      ...
      {/* 1. Top Badge: Sets the "Reference" Expectation */}
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        {/* 2. Hero Specs (The Trinity) - No specific models, just power levels */}
        <div className="grid grid-cols-1 gap-2 mb-6">
            ...
            <div className="flex items-center gap-3 bg-carbon-black p-2 rounded border border-white/5">
                <FaLayerGroup className="text-neon-cyan text-sm" />
        ...
        {/* 3. Software Badges (Clean) */}
        {build.compatible_software?.length > 0 && (
          <div className="mb-6">
            <p className="text-[10px] uppercase tracking-widest text-gray-500 mb-2 font-bold">Optimizado para</p>
