...
const CondicionesDeUso = () => {
  return (
    <div className="container mx-auto px-6 py-10">
      ...
      <p>
        Bienvenido a <strong>VLCExtreme</strong>. Al acceder a nuestro sitio web (<a href="https://vlcextreme.com" className="text-neon-cyan">vlcextreme.com</a>),
      ...
      <p>Todos los textos, imágenes y código en este sitio están protegidos por derechos de autor. No se permite su uso sin autorización expresa de VLCExtreme.</p>

      <h2 className="text-2xl font-bold mt-6">3. Limitación de Responsabilidad</h2>
      <p>VLCExtreme no se hace responsable de errores en el contenido ni de daños derivados del uso del sitio web.</p>
