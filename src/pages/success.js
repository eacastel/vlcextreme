    ...
    <div className="min-h-screen bg-carbon-black text-light-gray flex items-center justify-center">
      <div className="text-center max-w-lg px-6 py-10 bg-dark-gray border border-gray-700 rounded-lg shadow-lg">
        ...
        <p className="text-lg text-medium-gray mb-6">
          Gracias por tu compra. Recibirás un correo de confirmación en breve. Por favor revisa tu correo y Spam. Si por algún motivo no lo recibes <Link to="/contact" className="text-neon-cyan font-semibold">envíanos un mensaje</Link> y nos pondremos en contacto contigo.
        </p>
